    ...
    >
      ...
      <div className="z-10">
        ...
        <div className="socials flex flex-row gap-2">
          <Link href="https://github.com/amshugannu">
            <Image src={GithubIcon} alt="Github Icon" />
          </Link>
          <Link href="https://www.linkedin.com/in/amshu-gannu/">
            <Image src={LinkedinIcon} alt="Linkedin Icon" />
          </Link>
          <Link href="https://mail.google.com/mail/u/0/#inbox?compose=DmwnWsLWPcKjfdrKPxGcvRGnMrFjmxKLDRNqGHBdRXGBJGtJmmplXRcBsWvCGSFDzzRMQbRzwmMv">
